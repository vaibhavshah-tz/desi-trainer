...
class Metronic
{
    ...
    {
        $themes = [];
        // if (starts_with(\Route::currentRouteName(), 'tickets.')){
            if(\Request::is('tickets/*')){
            $themes[] = 'css/themes/layout/header/base/' . config('layout_ticket.header.self.theme') . '.css';
            $themes[] = 'css/themes/layout/header/menu/' . config('layout_ticket.header.menu.desktop.submenu.theme') . '.css';
            $themes[] = 'css/themes/layout/aside/' . config('layout_ticket.aside.self.theme') . '.css';

            if (config('layout_ticket.aside.self.display')) {
                $themes[] = 'css/themes/layout/brand/' . config('layout_ticket.brand.self.theme') . '.css';
            } else {
                $themes[] = 'css/themes/layout/brand/' . config('layout_ticket.header.self.theme') . '.css';
            }
        } else {
