...
(glob.sync('node_modules/+(@fortawesome|socicon|line-awesome|summernote)/**/*.+(woff|woff2|eot|ttf)') || []).forEach(file => {
...
mix.scripts(['node_modules/nexmo-client/dist/nexmoClient.min.js'], 'public/plugins/custom/nexmo-client/nexmoClient.min.js');