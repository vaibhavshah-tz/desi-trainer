...
{{-- Breadcrumb --}}
@section('breadcrumbs')
{{ Breadcrumbs::render('assigned-tickets') }}
@endsection
...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label">{{ __('Assigned Ticket Listing') }}</h3>
        </div>
    ...
    var KTDatatablesSearchOptionsColumnSearch = function() {
        ...
        var initTable1 = function() {
			...
			<'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
                ...
                ajax: {
                    url: '/tickets/get-list?assigned=1',
                    type: 'GET',
                    data: {
                        // pass data
                    },
                ...
                columnDefs: [{
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            return '<button class="btn btn-sm btn-primary isGlobal remove-global-btn" data-id="' + data.id + '" data-is-global="' + data.is_global + '" data-toggle="tooltip" data-theme="dark" title="' + globalText + '">' + globalText + '</button>\
